					  ...
					  <%AlcoholImage image = imageList.get(i); %>
					  	<%if(i==0){ %>
						    <div class="item active">
						      <img name="photo" class="img-thumbnail" src="/data/<%=imageList.get(0).getFilename()%>" alt="" style="width: 100%;height: 300px;">
						    </div>
					  	<%}else{ %>
					  		<div class="item">
						      <img name="photo" class="img-thumbnail" src="/data/<%=image.getFilename()%>" alt="" style="width: 100%;height: 300px;">
						    </div>
					  	<%} %>
					  <%} %>
                  ...
                  <div class="card card-user">
                     <div class="card-header">
                        <h5 class="card-title">술 세부 정보</h5>
	                 	<input type="hidden" id="alcohol_id" name="alcohol_id" value="<%=alcohol.getAlcohol_id() %>" />
                     </div>
                     <div class="card-body">
                        <form enctype="multipart/form-data">
                           <div class="row">
                              ...
                              <div class="col-md-5 pr-1">
                                 <div class="form-group">
                                    <label>술 이름</label> <input type="text" class="form-control" name="name"
                                       placeholder="Input Alcohol's Name" value="<%=alcohol.getName()%>">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label for="topcategory">Top 카테고리</label> 
                                    <select class="form-control"
                                       onchange="searchSubcategory(this)" id="topcategory"
                                       name="topcategory_id" style="font-size: 14px;height: 50px;">
                                       <option value="<%=alcohol.getSubcategory().getTopcategory().getTopcategory_id()%>"><%=alcohol.getSubcategory().getTopcategory().getName() %></option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6">
                                 <div class="form-group">
                                    <label for="subcategory">Sub 카테고리</label> 
                                    <select class="form-control"
                                       id="subcategory" name="subcategory_id" style="font-size: 14px;height: 50px;">
                                       <option value="<%=alcohol.getSubcategory().getSubcategory_id()%>"><%=alcohol.getSubcategory().getName() %></option>
                                    </select>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-md-6 pr-1">
                                 <div class="form-group">
                                    ...
                                    <input type="text" id="degree" name="degree" class="form-control" placeholder="Input Degree" value="<%=alcohol.getDegree()%>">
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                           ...
                           <div class="row">
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <textarea id="detail" name="detail" class="form-control textarea" placeholder="Input Details"><%=alcohol.getDetail() %></textarea>
                                 </div>
                              </div>
                           </div>
                           <div class="row">
                              <div class="update ml-auto mr-auto">
                                 <button type="button" class="btn btn-primary btn-round" data-toggle="modal" data-target="#editModal">
                                    수정하기</button>
                                 <button type="button" name="list_btn" class="btn btn-primary btn-round">
                                    돌아가기</button>
                              </div>
                           </div>
                        </form>

				...
				<div class="top-menu">
					<div class="row">
						...
						<div class="col-xs-8 text-right menu-1">
							<ul>
								<li class="has-dropdown"><a href="" style="font-size:20px;">탑1</a>
									<ul class="dropdown">
										<li><a href="#">서브1</a></li>
										<li><a href="#">서브2</a></li>
									</ul>
								...
								<li class="has-dropdown" ><a href="" style="font-size:20px;">탑2</a>
									<ul class="dropdown">
										<li><a href="#">서브1</a></li>
										<li><a href="#">서브2</a></li>
									</ul>
				...
				<div class="row">
					...
					<nav class="blog-pagination justify-content-center d-flex">
						...
						&& Integer.parseInt(request.getParameter("currentPage")) == i) {%>
								class="active" <%}%>><a href="/alcohols?currentPage=<%=i%>"><%=i%></a></li>
							<%
								}
							%>
